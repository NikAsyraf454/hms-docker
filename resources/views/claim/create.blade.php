            ...
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="members-tab" data-bs-toggle="tab" data-bs-target="#members"
                            type="button" role="tab" aria-controls="members" aria-selected="true">Member's Rental</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="depo-tab" data-bs-toggle="tab" data-bs-target="#depo"
                            type="button" role="tab" aria-controls="depo" aria-selected="false">Depo Morning</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="extra-tab" data-bs-toggle="tab" data-bs-target="#extra"
                            type="button" role="tab" aria-controls="extra" aria-selected="false">Extra Job</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="claim-tab" data-bs-toggle="tab" data-bs-target="#claim"
                            type="button" role="tab" aria-controls="claim" aria-selected="false">Staff Claim</button>
                    </li>
                </ul>
                <div class="tab-content pt-2" id="myTabContent">
                    ...
                    <div class="tab-pane fade" id="depo" role="tabpanel" aria-labelledby="depo-tab">
                        <form action="{{ route('claim.store', ['id' => 'depo']) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" class="" id="staff_id" name="staff_id" value="{{ $userId }}">
                            ...
                            <div class="col-6">
                                ...
                                <input type="number" class="form-control" placeholder="RM" name="amount" id="amount">
                            </div>
                            <div class="col-6">
                                <label for="date" class="form-label">Date</label>
                                <input type="date" class="form-control date" name="date" id="date">
                    ...
                    <div class="tab-pane fade" id="extra" role="tabpanel" aria-labelledby="extra-tab">
                      <form action="{{ route('claim.store', ['id' => 'extra']) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" class="" id="staff_id" name="staff_id" value="{{ $userId }}">
                            ...
                            <div class="col-6">
                                <label for="details" class="form-label">Destination</label>
                                <input type="text" class="form-control" name="details" id="details">
                            </div>
                            <div class="col-6">
                                <label for="date" class="form-label">Date</label>
                    ...
                    <div class="tab-pane fade" id="claim" role="tabpanel" aria-labelledby="claim-tab">
                        <form action="{{ route('claim.store', ['id'=>'claim']) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" class="" id="staff_id" name="staff_id" value="{{ $userId }}">
                            <div class="col-12">
